...
└── .env
```
### Explicação baseada no diretório
Esquema feito a mão, explicando a função e interrelação entre os arquivos dentro do esquema arquitetônico do software.

<div align="left">
  <img src="img/esquema_02.jpg" alt="Queen of Sheba" width="400" height="600">
  <img src="img/esquema_01.jpg" alt="Queen of Sheba" width="400" height="600">
</div>
